  ...
  return (
    ...
    <div className='h-[48rem] w-full text-white flex justify-end' style={{backgroundColor: "#1b273a"}}>
        <div className='relative flex flex-col md:pl-40 pl-12 justify-center '>
            <div className='text-lg z-20 pt-20'>CRANE BUSINESS
                <div className='pt-6 gap-5'>
                <div className='text-7xl font-bold flex gap-5'><div className='md:h-40 h-72 w-1 bg-yellow-500'></div>WE OFFER <br/>GREAT SERVICE</div>
                </div>
